...
.method private constructor <init>(Landroid/content/Context;Ljava/lang/String;)V
    ...
    .line 1058
    :try_start_0
    invoke-virtual {p0}, Lu/aly/db;->getWritableDatabase()Landroid/database/sqlite/SQLiteDatabase;
    ...
    invoke-static {v1, v0}, Lu/aly/db;->a(Ljava/lang/String;Landroid/database/sqlite/SQLiteDatabase;)Z
    ...
    .line 1061
    :cond_2
    invoke-direct {p0, v0}, Lu/aly/db;->c(Landroid/database/sqlite/SQLiteDatabase;)Z
    ...
    .line 1064
    invoke-direct {p0, v0}, Lu/aly/db;->b(Landroid/database/sqlite/SQLiteDatabase;)Z
    ...
    .line 1067
    invoke-direct {p0, v0}, Lu/aly/db;->a(Landroid/database/sqlite/SQLiteDatabase;)Z
    :try_end_0
...
.method private constructor <init>(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {v0, p1, p2}, Lu/aly/ee;-><init>(Landroid/content/Context;Ljava/lang/String;)V

    invoke-direct {p0, v0, p3}, Lu/aly/db;-><init>(Landroid/content/Context;Ljava/lang/String;)V
...
.method synthetic constructor <init>(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;B)V
    ...
    .prologue
    .line 18
    invoke-direct {p0, p1, p2, p3}, Lu/aly/db;-><init>(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)V
...
.method static synthetic a()Landroid/content/Context;
    ...
    .prologue
    .line 18
    sget-object v0, Lu/aly/db;->b:Landroid/content/Context;
...
.method public static declared-synchronized a(Landroid/content/Context;)Lu/aly/db;
    ...
    :try_start_0
    sput-object p0, Lu/aly/db;->b:Landroid/content/Context;

    .line 30
    invoke-static {}, Lu/aly/dc;->a()Lu/aly/db;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method private a(Landroid/database/sqlite/SQLiteDatabase;)Z
    ...
    iput-object v0, p0, Lu/aly/db;->a:Ljava/lang/String;

    .line 128
    iget-object v0, p0, Lu/aly/db;->a:Ljava/lang/String;
...
.method public final onCreate(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    .line 111
    invoke-direct {p0, p1}, Lu/aly/db;->c(Landroid/database/sqlite/SQLiteDatabase;)Z

    .line 112
    invoke-direct {p0, p1}, Lu/aly/db;->b(Landroid/database/sqlite/SQLiteDatabase;)Z

    .line 113
    invoke-direct {p0, p1}, Lu/aly/db;->a(Landroid/database/sqlite/SQLiteDatabase;)Z
