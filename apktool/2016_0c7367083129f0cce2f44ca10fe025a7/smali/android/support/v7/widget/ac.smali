...
.method private constructor <init>(Landroid/support/v7/widget/x;)V
    ...
    .prologue
    .line 1033
    iput-object p1, p0, Landroid/support/v7/widget/ac;->a:Landroid/support/v7/widget/x;
...
.method synthetic constructor <init>(Landroid/support/v7/widget/x;B)V
    .locals 0

    .prologue
    .line 1033
    invoke-direct {p0, p1}, Landroid/support/v7/widget/ac;-><init>(Landroid/support/v7/widget/x;)V
...
.method private varargs a([Ljava/lang/Object;)Ljava/lang/Void;
    ...
    .line 1044
    :try_start_0
    iget-object v3, p0, Landroid/support/v7/widget/ac;->a:Landroid/support/v7/widget/x;
    ...
    iget-object v8, v1, Landroid/support/v7/widget/aa;->a:Landroid/content/ComponentName;
    ...
    iget-wide v8, v1, Landroid/support/v7/widget/aa;->b:J
    ...
    iget v1, v1, Landroid/support/v7/widget/aa;->c:F
    ...
    .line 1084
    iget-object v0, p0, Landroid/support/v7/widget/ac;->a:Landroid/support/v7/widget/x;

    invoke-static {v0}, Landroid/support/v7/widget/x;->c(Landroid/support/v7/widget/x;)Z
    ...
    iget-object v4, p0, Landroid/support/v7/widget/ac;->a:Landroid/support/v7/widget/x;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/ac;->a:Landroid/support/v7/widget/x;

    invoke-static {v1}, Landroid/support/v7/widget/x;->c(Landroid/support/v7/widget/x;)Z
...
.method public final synthetic doInBackground([Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .prologue
    .line 1033
    invoke-direct {p0, p1}, Landroid/support/v7/widget/ac;->a([Ljava/lang/Object;)Ljava/lang/Void;
