...
.field private rawCall:Lokhttp3/g;
...
.method private createRawCall()Lokhttp3/g;
    .locals 2
    ...
    invoke-virtual {v0, v1}, Lretrofit2/ServiceMethod;->toRequest([Ljava/lang/Object;)Lokhttp3/as;
    ...
    iget-object v1, v1, Lretrofit2/ServiceMethod;->callFactory:Lokhttp3/h;

    invoke-interface {v1, v0}, Lokhttp3/h;->a(Lokhttp3/as;)Lokhttp3/g;
...
.method public final cancel()V
    ...
    .line 226
    :try_start_0
    iget-object v0, p0, Lretrofit2/OkHttpCall;->rawCall:Lokhttp3/g;
    ...
    .line 229
    invoke-interface {v0}, Lokhttp3/g;->c()V
...
.method public final enqueue(Lretrofit2/Callback;)V
    ...
    .line 81
    iget-object v2, p0, Lretrofit2/OkHttpCall;->rawCall:Lokhttp3/g;
    ...
    .line 85
    :try_start_2
    invoke-direct {p0}, Lretrofit2/OkHttpCall;->createRawCall()Lokhttp3/g;

    move-result-object v1

    iput-object v1, p0, Lretrofit2/OkHttpCall;->rawCall:Lokhttp3/g;
    :try_end_2
    ...
    .line 98
    invoke-interface {v1}, Lokhttp3/g;->c()V
    ...
    invoke-interface {v1, v0}, Lokhttp3/g;->a(Lokhttp3/i;)V
...
.method public final execute()Lretrofit2/Response;
    ...
    iput-object v0, p0, Lretrofit2/OkHttpCall;->rawCall:Lokhttp3/g;
    :try_end_2
    ...
    .line 174
    :cond_4
    invoke-interface {v0}, Lokhttp3/g;->b()Lokhttp3/ay;

    move-result-object v0

    invoke-virtual {p0, v0}, Lretrofit2/OkHttpCall;->parseResponse(Lokhttp3/ay;)Lretrofit2/Response;
...
.method final parseResponse(Lokhttp3/ay;)Lretrofit2/Response;
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 187
    .line 1172
    iget-object v1, p1, Lokhttp3/ay;->f:Lokhttp3/ba;

    .line 190
    invoke-virtual {p1}, Lokhttp3/ay;->b()Lokhttp3/az;
    ...
    .line 191
    invoke-virtual {v1}, Lokhttp3/ba;->contentType()Lokhttp3/ai;

    move-result-object v3

    invoke-virtual {v1}, Lokhttp3/ba;->contentLength()J

    move-result-wide v4

    invoke-direct {v2, v3, v4, v5}, Lretrofit2/OkHttpCall$NoContentResponseBody;-><init>(Lokhttp3/ai;J)V

    .line 1372
    iput-object v2, v0, Lokhttp3/az;->g:Lokhttp3/ba;
    ...
    :cond_0
    :try_start_0
    invoke-static {v1}, Lretrofit2/Utils;->buffer(Lokhttp3/ba;)Lokhttp3/ba;

    move-result-object v2

    .line 199
    invoke-static {v2, v0}, Lretrofit2/Response;->error(Lokhttp3/ba;Lokhttp3/ay;)Lretrofit2/Response;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    invoke-static {v1, v0}, Lretrofit2/Response;->success(Ljava/lang/Object;Lokhttp3/ay;)Lretrofit2/Response;
    ...
    invoke-direct {v2, v1}, Lretrofit2/OkHttpCall$ExceptionCatchingRequestBody;-><init>(Lokhttp3/ba;)V

    .line 211
    :try_start_1
    iget-object v1, p0, Lretrofit2/OkHttpCall;->serviceMethod:Lretrofit2/ServiceMethod;

    invoke-virtual {v1, v2}, Lretrofit2/ServiceMethod;->toResponse(Lokhttp3/ba;)Ljava/lang/Object;
...
.method public final declared-synchronized request()Lokhttp3/as;
    .locals 3
    ...
    .line 51
    invoke-interface {v0}, Lokhttp3/g;->a()Lokhttp3/as;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
