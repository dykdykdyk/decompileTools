...
.field final callFactory:Lokhttp3/h;
...
.method constructor <init>(Lretrofit2/ServiceMethod$Builder;)V
    ...
    invoke-virtual {v0}, Lretrofit2/Retrofit;->callFactory()Lokhttp3/h;

    move-result-object v0

    iput-object v0, p0, Lretrofit2/ServiceMethod;->callFactory:Lokhttp3/h;
    ...
    invoke-virtual {v0}, Lretrofit2/Retrofit;->baseUrl()Lokhttp3/ad;

    move-result-object v0

    iput-object v0, p0, Lretrofit2/ServiceMethod;->baseUrl:Lokhttp3/ad;
    ...
    .line 86
    iget-object v0, p1, Lretrofit2/ServiceMethod$Builder;->headers:Lokhttp3/ab;

    iput-object v0, p0, Lretrofit2/ServiceMethod;->headers:Lokhttp3/ab;

    .line 87
    iget-object v0, p1, Lretrofit2/ServiceMethod$Builder;->contentType:Lokhttp3/ai;

    iput-object v0, p0, Lretrofit2/ServiceMethod;->contentType:Lokhttp3/ai;
...
# virtual methods
.method final varargs toRequest([Ljava/lang/Object;)Lokhttp3/as;
    .locals 10
    ...
    iget-object v2, p0, Lretrofit2/ServiceMethod;->baseUrl:Lokhttp3/ad;

    iget-object v3, p0, Lretrofit2/ServiceMethod;->relativeUrl:Ljava/lang/String;

    iget-object v4, p0, Lretrofit2/ServiceMethod;->headers:Lokhttp3/ab;

    iget-object v5, p0, Lretrofit2/ServiceMethod;->contentType:Lokhttp3/ai;
    ...
    invoke-direct/range {v0 .. v8}, Lretrofit2/RequestBuilder;-><init>(Ljava/lang/String;Lokhttp3/ad;Ljava/lang/String;Lokhttp3/ab;Lokhttp3/ai;ZZZ)V
    ...
    .line 112
    :cond_2
    invoke-virtual {v0}, Lretrofit2/RequestBuilder;->build()Lokhttp3/as;
...
.method final toResponse(Lokhttp3/ba;)Ljava/lang/Object;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
