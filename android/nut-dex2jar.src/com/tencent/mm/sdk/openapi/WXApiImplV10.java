  ...
  implements IWXAPI
{
  ...
  private static WXApiImplV10.ActivityLifecycleCb activityCb = null;
  ...
  private void initMta(Context paramContext, String paramString)
  {
    ...
    t.a(paramContext, paramString);
    t.l();
    t.a(u.f);
    t.j();
    t.b(paramContext, "Wechat_Sdk");
    try
    {
      v.a(paramContext, paramString, "2.0.3");
      return;
    }
  ...
  public final boolean registerApp(String paramString)
  {
    ...
    if ((activityCb == null) && (Build.VERSION.SDK_INT >= 14))
    {
      ...
      activityCb = new WXApiImplV10.ActivityLifecycleCb(this.context, null);
