...
public class UserSettingsFragment extends FacebookFragment
{
    ...
    if (isSessionOpen())
    {
      ...
      if (this.user != null)
      {
        ...
        while (true)
        {
          ...
          return;
          label146: ImageDownloader.downloadAsync((ImageRequest)localObject);
        }
      }
  ...
  {
    this.loginButtonProperties.setPublishPermissions(Arrays.asList(paramArrayOfString), getSession());
  }
  ...
  {
    this.loginButtonProperties.setReadPermissions(Arrays.asList(paramArrayOfString), getSession());
  }
