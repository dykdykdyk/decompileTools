...
class GraphObjectPagingLoader<T extends GraphObject> extends g<SimpleGraphObjectCursor<T>>
{
  ...
  private void addResults(Response paramResponse)
  {
    ...
    while (true)
    {
      ...
      label158: i = 0;
      break label69;
      label163: localSimpleGraphObjectCursor.setMoreObjectsAvailable(false);
    }
  }
  ...
  private void requestCompleted(Response paramResponse)
  {
    ...
    label94: addResults(paramResponse);
  }
