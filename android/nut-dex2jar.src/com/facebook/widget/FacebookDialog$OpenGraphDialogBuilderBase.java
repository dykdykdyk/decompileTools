...
abstract class FacebookDialog$OpenGraphDialogBuilderBase<CONCRETE extends OpenGraphDialogBuilderBase<?>> extends FacebookDialog.Builder<CONCRETE>
{
    ...
    throws JSONException
  {
    ...
    while (i < j)
    {
      ((JSONArray)localObject).put(flattenObject(paramObject.get(i)));
      i += 1;
    }
    return localObject;
  }
