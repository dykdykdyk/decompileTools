  ...
  implements SectionIndexer
{
  ...
  private void downloadProfilePicture(String paramString, URI paramURI, ImageView paramImageView)
  {
    ...
    while (true)
    {
      ...
      for (int i = 1; (i != 0) || (!paramURI.equals(paramImageView.getTag())); i = 0)
      {
        ...
        paramURI = new ImageRequest.Builder(this.context.getApplicationContext(), paramURI).setCallerTag(this).setCallback(new GraphObjectAdapter.2(this, paramString, paramImageView)).build();
  ...
  protected View createGraphObjectView(T paramT)
  {
    ...
    while (true)
    {
      ...
      localViewStub.setVisibility(8);
      return paramT;
      label68: updateCheckboxState((CheckBox)localViewStub.inflate(), false);
    }
  ...
  protected URI getPictureUriOfGraphObject(T paramT)
  {
    ...
    if ((paramT instanceof String));
    label84: for (paramT = (String)paramT; ; paramT = null)
    {
      while (paramT != null)
        try
        {
  ...
  protected void populateGraphObjectView(View paramView, T paramT)
  {
    ...
    while (true)
    {
      ...
      return;
      label191: localTextView.setVisibility(8);
    }
