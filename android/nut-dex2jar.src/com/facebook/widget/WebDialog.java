...
public class WebDialog extends Dialog
{
  ...
  private void calculateSize()
  {
    ...
    label140: for (int j = localDisplayMetrics.heightPixels; ; j = localDisplayMetrics.widthPixels)
    {
  ...
  protected void sendErrorToListener(Throwable paramThrowable)
  {
    ...
    label47: for (paramThrowable = (FacebookException)paramThrowable; ; paramThrowable = new FacebookException(paramThrowable))
    {
