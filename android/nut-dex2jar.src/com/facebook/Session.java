  ...
  implements Serializable
{
  ...
  static void postActiveSessionAction(String paramString)
  {
    ...
    j.a(getStaticContext()).a(paramString);
  }
  ...
  public boolean equals(Object paramObject)
  {
    ...
    while ((!areEqual(paramObject.applicationId, this.applicationId)) || (!areEqual(paramObject.authorizationBundle, this.authorizationBundle)) || (!areEqual(paramObject.state, this.state)) || (!areEqual(paramObject.getExpirationDate(), getExpirationDate())));
    return true;
  }
  ...
  {
    StringBuilder localStringBuilder = new StringBuilder("{Session state:").append(this.state).append(", token:");
    if (this.tokenInfo == null)
    {
      localObject = "null";
    ...
    label81: for (Object localObject = "null"; ; localObject = this.applicationId)
    {
