...
public class Response
{
  ...
  static List<Response> fromHttpConnection(HttpURLConnection paramHttpURLConnection, RequestBatch paramRequestBatch)
  {
    ...
    //   15: ifeq +546 -> 561
    //   18: aload_1
    //   19: checkcast 281	com/facebook/internal/CacheableRequestBatch
    //   22: astore 8
    //   24: invokestatic 285	com/facebook/Response:getResponseCache	()Lcom/facebook/internal/FileLruCache;
    //   27: astore 4
    //   29: aload 8
    //   31: invokevirtual 288	com/facebook/internal/CacheableRequestBatch:getCacheKeyOverride	()Ljava/lang/String;
    //   34: astore_3
    //   35: aload_3
    //   36: astore_2
    //   37: aload_3
    //   38: invokestatic 292	com/facebook/internal/Utility:isNullOrEmpty	(Ljava/lang/String;)Z
    //   41: ifeq +20 -> 61
    //   44: aload_1
    //   45: invokevirtual 293	com/facebook/RequestBatch:size	()I
    //   48: iconst_1
    //   49: if_icmpne +68 -> 117
    //   52: aload_1
    //   53: iconst_0
    //   54: invokevirtual 296	com/facebook/RequestBatch:get	(I)Lcom/facebook/Request;
    //   57: invokevirtual 299	com/facebook/Request:getUrlForSingleRequest	()Ljava/lang/String;
    //   60: astore_2
    //   61: aload 8
    //   63: invokevirtual 302	com/facebook/internal/CacheableRequestBatch:getForceRoundTrip	()Z
    //   66: ifne +485 -> 551
    //   69: aload 4
    //   71: ifnull +480 -> 551
    //   74: aload_2
    //   75: invokestatic 292	com/facebook/internal/Utility:isNullOrEmpty	(Ljava/lang/String;)Z
    //   78: ifne +473 -> 551
    //   81: aload 4
    //   83: aload_2
    //   84: invokevirtual 307	com/facebook/internal/FileLruCache:get	(Ljava/lang/String;)Ljava/io/InputStream;
    //   87: astore_3
    //   88: aload_3
    //   89: ifnull +44 -> 133
    //   92: aload_3
    ...
    //   103: aload_1
    //   104: iconst_1
    //   105: invokestatic 309	com/facebook/Response:createResponsesFromStream	(Ljava/io/InputStream;Ljava/net/HttpURLConnection;Lcom/facebook/RequestBatch;Z)Ljava/util/List;
    //   108: astore 8
    //   110: aload_3
    //   111: invokestatic 313	com/facebook/internal/Utility:closeQuietly	(Ljava/io/Closeable;)V
    //   114: aload 8
    //   116: areturn
    //   117: getstatic 267	com/facebook/LoggingBehavior:REQUESTS	Lcom/facebook/LoggingBehavior;
    //   120: ldc 22
    //   122: ldc_w 315
    //   125: invokestatic 318	com/facebook/internal/Logger:log	(Lcom/facebook/LoggingBehavior;Ljava/lang/String;Ljava/lang/String;)V
    //   128: aload_3
    //   129: astore_2
    //   130: goto -69 -> 61
    //   133: aload_3
    //   134: invokestatic 313	com/facebook/internal/Utility:closeQuietly	(Ljava/io/Closeable;)V
    //   137: aload_2
    //   138: astore 5
    //   140: aload_3
    //   141: astore_2
    ...
    //   155: astore_3
    //   156: aload_0
    //   157: invokevirtual 205	java/net/HttpURLConnection:getResponseCode	()I
    //   160: sipush 400
    ...
    //   179: astore_3
    //   180: aload_0
    //   181: invokevirtual 322	java/net/HttpURLConnection:getErrorStream	()Ljava/io/InputStream;
    //   184: astore_2
    //   185: aload_2
    //   186: astore 7
    //   188: aload_2
    ...
    //   201: aload_1
    //   202: iconst_0
    //   203: invokestatic 309	com/facebook/Response:createResponsesFromStream	(Ljava/io/InputStream;Ljava/net/HttpURLConnection;Lcom/facebook/RequestBatch;Z)Ljava/util/List;
    //   206: astore 4
    //   208: aload_2
    //   209: invokestatic 313	com/facebook/internal/Utility:closeQuietly	(Ljava/io/Closeable;)V
    //   212: aload 4
    //   214: areturn
    //   215: astore_3
    //   216: aconst_null
    //   217: astore_3
    //   218: aload_3
    //   219: invokestatic 313	com/facebook/internal/Utility:closeQuietly	(Ljava/io/Closeable;)V
    //   222: aload_2
    //   223: astore 5
    //   225: aload_3
    //   226: astore_2
    ...
    //   230: astore_3
    //   231: aload 5
    //   233: invokestatic 313	com/facebook/internal/Utility:closeQuietly	(Ljava/io/Closeable;)V
    //   236: aload_2
    //   237: astore_3
    //   238: aload 5
    //   240: astore_2
    ...
    //   247: astore_3
    //   248: aload 6
    //   250: invokestatic 313	com/facebook/internal/Utility:closeQuietly	(Ljava/io/Closeable;)V
    //   253: aload_2
    //   254: astore 5
    //   256: aload 6
    //   258: astore_2
    ...
    //   262: astore_0
    //   263: aload 7
    //   265: invokestatic 313	com/facebook/internal/Utility:closeQuietly	(Ljava/io/Closeable;)V
    //   268: aload_0
    //   269: athrow
    //   270: aload_2
    //   271: astore 7
    ...
    //   283: astore_3
    //   284: aload_0
    //   285: invokevirtual 325	java/net/HttpURLConnection:getInputStream	()Ljava/io/InputStream;
    //   288: astore 6
    //   290: aload 6
    //   292: astore_2
    //   293: aload 4
    ...
    //   335: aload 5
    //   337: aload 6
    //   339: invokevirtual 329	com/facebook/internal/FileLruCache:interceptAndPut	(Ljava/lang/String;Ljava/io/InputStream;)Ljava/io/InputStream;
    //   342: astore 4
    //   344: aload 6
    //   346: astore_2
    //   347: aload 4
    ...
    //   359: aload 7
    //   361: astore_3
    //   362: getstatic 267	com/facebook/LoggingBehavior:REQUESTS	Lcom/facebook/LoggingBehavior;
    //   365: ldc 25
    //   367: ldc_w 331
    //   370: iconst_1
    ...
    //   376: aload_2
    //   377: aastore
    //   378: invokestatic 250	com/facebook/internal/Logger:log	(Lcom/facebook/LoggingBehavior;Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   381: aload 7
    //   383: astore_3
    //   384: aload_1
    //   385: aload_0
    //   386: aload_2
    //   387: invokestatic 333	com/facebook/Response:constructErrorResponses	(Ljava/util/List;Ljava/net/HttpURLConnection;Lcom/facebook/FacebookException;)Ljava/util/List;
    //   390: astore_0
    //   391: aload 7
    //   393: invokestatic 313	com/facebook/internal/Utility:closeQuietly	(Ljava/io/Closeable;)V
    //   396: aload_0
    //   397: areturn
    //   398: astore_2
    //   399: aload 8
    //   401: astore_3
    //   402: getstatic 267	com/facebook/LoggingBehavior:REQUESTS	Lcom/facebook/LoggingBehavior;
    //   405: ldc 25
    //   407: ldc_w 331
    //   410: iconst_1
    ...
    //   416: aload_2
    //   417: aastore
    //   418: invokestatic 250	com/facebook/internal/Logger:log	(Lcom/facebook/LoggingBehavior;Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   421: aload 8
    //   423: astore_3
    //   424: aload_1
    //   425: aload_0
    //   426: new 167	com/facebook/FacebookException
    //   429: dup
    //   430: aload_2
    //   431: invokespecial 336	com/facebook/FacebookException:<init>	(Ljava/lang/Throwable;)V
    //   434: invokestatic 333	com/facebook/Response:constructErrorResponses	(Ljava/util/List;Ljava/net/HttpURLConnection;Lcom/facebook/FacebookException;)Ljava/util/List;
    //   437: astore_0
    //   438: aload 8
    //   440: invokestatic 313	com/facebook/internal/Utility:closeQuietly	(Ljava/io/Closeable;)V
    //   443: aload_0
    //   444: areturn
    //   445: astore_2
    //   446: aload 9
    //   448: astore_3
    //   449: getstatic 267	com/facebook/LoggingBehavior:REQUESTS	Lcom/facebook/LoggingBehavior;
    //   452: ldc 25
    //   454: ldc_w 331
    //   457: iconst_1
    ...
    //   463: aload_2
    //   464: aastore
    //   465: invokestatic 250	com/facebook/internal/Logger:log	(Lcom/facebook/LoggingBehavior;Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   468: aload 9
    //   470: astore_3
    //   471: aload_1
    //   472: aload_0
    //   473: new 167	com/facebook/FacebookException
    //   476: dup
    //   477: aload_2
    //   478: invokespecial 336	com/facebook/FacebookException:<init>	(Ljava/lang/Throwable;)V
    //   481: invokestatic 333	com/facebook/Response:constructErrorResponses	(Ljava/util/List;Ljava/net/HttpURLConnection;Lcom/facebook/FacebookException;)Ljava/util/List;
    //   484: astore_0
    //   485: aload 9
    //   487: invokestatic 313	com/facebook/internal/Utility:closeQuietly	(Ljava/io/Closeable;)V
    //   490: aload_0
    //   491: areturn
    //   492: astore_2
    //   493: aload 10
    //   495: astore_3
    //   496: getstatic 267	com/facebook/LoggingBehavior:REQUESTS	Lcom/facebook/LoggingBehavior;
    //   499: ldc 25
    //   501: ldc_w 331
    //   504: iconst_1
    ...
    //   510: aload_2
    //   511: aastore
    //   512: invokestatic 250	com/facebook/internal/Logger:log	(Lcom/facebook/LoggingBehavior;Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   515: aload 10
    //   517: astore_3
    //   518: aload_1
    //   519: aload_0
    //   520: new 167	com/facebook/FacebookException
    //   523: dup
    //   524: aload_2
    //   525: invokespecial 336	com/facebook/FacebookException:<init>	(Ljava/lang/Throwable;)V
    //   528: invokestatic 333	com/facebook/Response:constructErrorResponses	(Ljava/util/List;Ljava/net/HttpURLConnection;Lcom/facebook/FacebookException;)Ljava/util/List;
    //   531: astore_0
    //   532: aload 10
    //   534: invokestatic 313	com/facebook/internal/Utility:closeQuietly	(Ljava/io/Closeable;)V
    //   537: aload_0
    //   538: areturn
    //   539: astore_0
    //   540: aload_3
    //   541: invokestatic 313	com/facebook/internal/Utility:closeQuietly	(Ljava/io/Closeable;)V
    //   544: aload_0
    //   545: athrow
    //   546: astore 5
    //   548: goto -330 -> 218
  ...
  public String toString()
  {
    try
    {
      ...
      {
        String str1 = String.format("%d", new Object[] { Integer.valueOf(i) });
