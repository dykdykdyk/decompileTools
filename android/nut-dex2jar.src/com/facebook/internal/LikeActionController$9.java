  ...
  implements PlatformServiceClient.CompletedListener
{
  ...
  public void completed(Bundle paramBundle)
  {
    ...
    if (paramBundle.containsKey("com.facebook.platform.extra.LIKE_COUNT_STRING_WITH_LIKE"))
    {
      ...
      label88: if (!paramBundle.containsKey("com.facebook.platform.extra.UNLIKE_TOKEN"))
        break label168;
    }
    label132: label144: label156: label168: for (paramBundle = paramBundle.getString("com.facebook.platform.extra.UNLIKE_TOKEN"); ; paramBundle = LikeActionController.access$1300(this.this$0))
    {
      LikeActionController.access$1500(this.this$0, bool, str1, str2, str3, str4, paramBundle);
      return;
