  ...
  implements FacebookDialog.Callback
{
  ...
  public void onComplete(FacebookDialog.PendingCall paramPendingCall, Bundle paramBundle)
  {
    ...
    label189: for (Bundle localBundle = new Bundle(); ; localBundle = this.val$analyticsParameters)
    {
      ...
      LikeActionController.access$1500(this.this$0, bool, (String)localObject1, str1, (String)localObject2, str2, paramBundle);
      return;
      paramBundle = LikeActionController.access$1300(this.this$0);
      break;
    }
  }
  ...
  public void onError(FacebookDialog.PendingCall paramPendingCall, Exception paramException, Bundle paramBundle)
  {
    ...
    for (paramException = new Bundle(); ; paramException = this.val$analyticsParameters)
    {
      ...
      LikeActionController.access$1700(this.this$0, "present_dialog", paramException);
