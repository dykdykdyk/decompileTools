...
public final class Utility
{
  ...
  public static Method getMethodQuietly(String paramString1, String paramString2, Class<?>[] paramArrayOfClass)
  {
    try
    {
      paramString1 = getMethodQuietly(Class.forName(paramString1), paramString2, paramArrayOfClass);
      return paramString1;
    }
  ...
  public static int[] intersectRanges(int[] paramArrayOfInt1, int[] paramArrayOfInt2)
  {
    ...
    label266: label276: label287: label300: for (i = paramArrayOfInt1[(i1 + 1)]; ; i = 2147483647)
    {
      if (n < paramArrayOfInt2.length - 1);
      for (int j = paramArrayOfInt2[(n + 1)]; ; j = 2147483647)
      {
        if (k < i2)
          if (i > i2)
          {
  ...
  public static void loadAppSettingsAsync(Context paramContext, String paramString)
  {
    ...
    while (true)
    {
      ...
      Utility.1 local1 = new Utility.1(paramString, paramContext, str);
    ...
    throws IOException
  {
    ...
    //   0: aconst_null
    //   1: astore_3
    //   2: new 650	java/io/BufferedInputStream
    //   5: dup
    //   6: aload_0
    //   7: invokespecial 653	java/io/BufferedInputStream:<init>	(Ljava/io/InputStream;)V
    //   10: astore_0
    //   11: new 655	java/io/InputStreamReader
    //   14: dup
    //   15: aload_0
    //   16: invokespecial 656	java/io/InputStreamReader:<init>	(Ljava/io/InputStream;)V
    //   19: astore_2
    ...
    //   35: aload_2
    //   36: aload 4
    //   38: invokevirtual 660	java/io/InputStreamReader:read	([C)I
    //   41: istore_1
    //   42: iload_1
    //   43: iconst_m1
    //   44: if_icmpeq +32 -> 76
    ...
    //   50: iconst_0
    //   51: iload_1
    //   52: invokevirtual 663	java/lang/StringBuilder:append	([CII)Ljava/lang/StringBuilder;
    //   55: pop
    //   56: goto -21 -> 35
    //   59: astore 4
    //   61: aload_0
    ...
    //   65: astore_0
    //   66: aload_3
    //   67: invokestatic 665	com/facebook/internal/Utility:closeQuietly	(Ljava/io/Closeable;)V
    //   70: aload_2
    //   71: invokestatic 665	com/facebook/internal/Utility:closeQuietly	(Ljava/io/Closeable;)V
    //   74: aload_0
    //   75: athrow
    //   76: aload_3
    ...
    //   80: astore_3
    //   81: aload_0
    //   82: invokestatic 665	com/facebook/internal/Utility:closeQuietly	(Ljava/io/Closeable;)V
    //   85: aload_2
    //   86: invokestatic 665	com/facebook/internal/Utility:closeQuietly	(Ljava/io/Closeable;)V
    //   89: aload_3
    //   90: areturn
    //   91: astore_0
    //   92: aconst_null
  ...
  public static void setAppEventAttributionParameters(GraphObject paramGraphObject, AttributionIdentifiers paramAttributionIdentifiers, String paramString, boolean paramBoolean)
  {
    ...
    label112: for (paramBoolean = bool2; ; paramBoolean = false)
    {
