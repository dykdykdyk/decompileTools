  ...
  implements RequestBatch.Callback
{
  ...
  public void onBatchCompleted(RequestBatch paramRequestBatch)
  {
    ...
    {
      Logger.log(LoggingBehavior.REQUESTS, LikeActionController.access$1600(), "Unable to refresh like state for id: '%s'", new Object[] { LikeActionController.access$2400(this.this$1.this$0) });
      return;
    }
