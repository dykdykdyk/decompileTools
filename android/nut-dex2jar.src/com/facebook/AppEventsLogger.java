...
public class AppEventsLogger
{
  ...
  private AppEventsLogger(Context paramContext, String arg2, Session paramSession)
  {
    ...
    synchronized (staticLock)
    {
      ...
      this.accessTokenAppId = new AppEventsLogger.AccessTokenAppIdPair(null, paramSession);
    }
  }
    ...
    catch (Exception paramFlushReason)
    {
      synchronized (staticLock)
      {
        ...
        if (paramFlushReason != null)
        {
          ...
          ((Intent)???).putExtra("com.facebook.sdk.APP_EVENTS_NUM_EVENTS_FLUSHED", paramFlushReason.numEvents);
          ((Intent)???).putExtra("com.facebook.sdk.APP_EVENTS_FLUSH_RESULT", paramFlushReason.result);
          j.a(applicationContext).a((Intent)???);
          return;
