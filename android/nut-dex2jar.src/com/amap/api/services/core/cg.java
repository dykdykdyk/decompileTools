...
public class cg
{
  ...
  cg(int paramInt1, int paramInt2, Proxy paramProxy, boolean paramBoolean)
  {
    this.b = paramInt1;
    this.c = paramInt2;
    this.f = paramProxy;
  ...
  // ERROR //
  private cl a(HttpURLConnection paramHttpURLConnection)
    throws ai, IOException
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore 4
    ...
    //   24: new 80	com/amap/api/services/core/ai
    //   27: dup
    ...
    //   56: invokespecial 118	com/amap/api/services/core/ai:<init>	(Ljava/lang/String;)V
    //   59: athrow
    //   60: astore_3
    //   61: aconst_null
    //   62: astore 4
    ...
    //   224: goto -22 -> 202
    //   227: getstatic 160	com/amap/api/services/core/cg:a	Lcom/amap/api/services/core/ch;
    //   230: ifnull +11 -> 241
    //   233: getstatic 160	com/amap/api/services/core/cg:a	Lcom/amap/api/services/core/ch;
    //   236: invokeinterface 164 1 0
    //   241: new 166	com/amap/api/services/core/cl
    //   244: dup
    //   245: invokespecial 167	com/amap/api/services/core/cl:<init>	()V
    //   248: astore 5
    //   250: aload 5
    //   252: aload 7
    //   254: invokevirtual 171	java/io/ByteArrayOutputStream:toByteArray	()[B
    //   257: putfield 174	com/amap/api/services/core/cl:a	[B
    //   260: aload 5
    //   262: aload 8
    //   264: putfield 177	com/amap/api/services/core/cl:b	Ljava/util/Map;
    //   267: aload 7
    //   269: ifnull +8 -> 277
    //   272: aload 7
    ...
    //   320: ldc 69
    //   322: ldc 179
    //   324: invokestatic 74	com/amap/api/services/core/ay:a	(Ljava/lang/Throwable;Ljava/lang/String;Ljava/lang/String;)V
    //   327: aload 7
    ...
    //   339: ldc 69
    //   341: ldc 179
    //   343: invokestatic 74	com/amap/api/services/core/ay:a	(Ljava/lang/Throwable;Ljava/lang/String;Ljava/lang/String;)V
    //   346: aload 6
    ...
    //   358: ldc 69
    //   360: ldc 179
    //   362: invokestatic 74	com/amap/api/services/core/ay:a	(Ljava/lang/Throwable;Ljava/lang/String;Ljava/lang/String;)V
    //   365: aload 5
    ...
    //   377: ldc 69
    //   379: ldc 179
    //   381: invokestatic 74	com/amap/api/services/core/ay:a	(Ljava/lang/Throwable;Ljava/lang/String;Ljava/lang/String;)V
    //   384: aload 4
    ...
    //   394: ldc 69
    //   396: ldc 179
    //   398: invokestatic 74	com/amap/api/services/core/ay:a	(Ljava/lang/Throwable;Ljava/lang/String;Ljava/lang/String;)V
    //   401: aload_1
    ...
    //   412: ldc 69
    //   414: ldc 179
    //   416: invokestatic 74	com/amap/api/services/core/ay:a	(Ljava/lang/Throwable;Ljava/lang/String;Ljava/lang/String;)V
    //   419: aload 7
    ...
    //   431: ldc 69
    //   433: ldc 179
    //   435: invokestatic 74	com/amap/api/services/core/ay:a	(Ljava/lang/Throwable;Ljava/lang/String;Ljava/lang/String;)V
    //   438: aload 6
    ...
    //   448: ldc 69
    //   450: ldc 179
    //   452: invokestatic 74	com/amap/api/services/core/ay:a	(Ljava/lang/Throwable;Ljava/lang/String;Ljava/lang/String;)V
    //   455: aload_3
    ...
    //   464: ldc 69
    //   466: ldc 179
    //   468: invokestatic 74	com/amap/api/services/core/ay:a	(Ljava/lang/Throwable;Ljava/lang/String;Ljava/lang/String;)V
    //   471: aload_3
    ...
    //   480: ldc 69
    //   482: ldc 179
    //   484: invokestatic 74	com/amap/api/services/core/ay:a	(Ljava/lang/Throwable;Ljava/lang/String;Ljava/lang/String;)V
    //   487: aload_1
  ...
  private void a(Map<String, String> paramMap, HttpURLConnection paramHttpURLConnection)
  {
    ...
    {
      while (true)
        ay.a(paramMap, "HttpUrlUtil", "addHeaders");
    }
  }

  cl a(String paramString, Map<String, String> paramMap1, Map<String, String> paramMap2)
    throws ai
  {
    try
    {
    ...
    {
      throw new ai("http连接失败 - ConnectionException");
    }
    ...
    {
      throw new ai("socket 连接异常 - SocketException");
    }
  ...
  cl a(String paramString, Map<String, String> paramMap, byte[] paramArrayOfByte)
    throws ai
  {
    try
    {
    ...
    {
      ay.a(paramString, "HttpUrlUtil", "makePostReqeust");
    }
    throw new ai("未知的错误");
  }
 ...
 * Qualified Name:     com.amap.api.services.core.cg
