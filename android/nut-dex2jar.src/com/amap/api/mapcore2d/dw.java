...
abstract class dw
{
  ...
  protected dw(Context paramContext)
  {
    try
    {
    ...
    {
      dn.a(paramContext, "LogProcessor", "LogUpDateProcessor");
      paramContext.printStackTrace();
    }
  }

  public static dw a(Context paramContext, int paramInt)
  {
    switch (paramInt)
    {
    default:
      return null;
    case 0:
      return new dr(paramContext);
    case 1:
      return new dt(paramContext);
    case 2:
    }
    return new do(paramContext);
  }

  private er a(Context paramContext, String paramString)
  {
    try
    {
      StringBuilder localStringBuilder = new StringBuilder();
      localStringBuilder.append(paramContext.getFilesDir().getAbsolutePath());
      localStringBuilder.append(dv.a);
      localStringBuilder.append(paramString);
      paramContext = new File(localStringBuilder.toString());
      if ((!paramContext.exists()) && (!paramContext.mkdirs()))
        return null;
      paramContext = er.a(paramContext, 1, 1, 20480L);
      return paramContext;
    }
    catch (IOException paramContext)
    {
      dn.a(paramContext, "LogProcessor", "initDiskLru");
      paramContext.printStackTrace();
      return null;
    }
    catch (Throwable paramContext)
  ...
  private String a(List<ek> paramList, Context paramContext)
  {
    StringBuilder localStringBuilder = new StringBuilder();
    ...
    {
      paramContext = (ek)paramList.next();
  ...
  private void a(ei paramei, int paramInt)
  {
    try
    {
      a(paramei.a(2, paramInt), paramei, paramInt);
      return;
    }
    catch (Throwable paramei)
    {
      dn.a(paramei, "LogProcessor", "processDeleteFail");
      paramei.printStackTrace();
    }
  }

  private void a(List<ek> paramList, ei paramei, int paramInt)
  {
    if ((paramList != null) && (paramList.size() > 0))
    {
      ...
      {
        ek localek = (ek)paramList.next();
        if (a(localek.b()))
        {
          paramei.a(localek.b(), paramInt);
        }
        else
        {
          localek.a(2);
          paramei.a(localek, localek.a());
        }
      }
    }
  }
  ...
  private int b(String paramString)
  {
    ...
    //   6: invokestatic 201	com/amap/api/mapcore2d/dj:b	([B)[B
    //   9: astore_3
    //   10: aload_3
    //   11: astore_1
    //   12: new 203	com/amap/api/mapcore2d/dx
    //   15: dup
    //   16: aload_1
    //   17: invokespecial 206	com/amap/api/mapcore2d/dx:<init>	([B)V
    //   20: astore_1
    //   21: iconst_0
    //   22: invokestatic 211	com/amap/api/mapcore2d/fa:a	(Z)Lcom/amap/api/mapcore2d/fa;
    //   25: aload_1
    //   26: invokevirtual 214	com/amap/api/mapcore2d/fa:a	(Lcom/amap/api/mapcore2d/fb;)[B
    //   29: astore_3
    //   30: aload_3
    //   31: ifnonnull +17 -> 48
    //   34: iconst_0
    ...
    //   41: invokestatic 201	com/amap/api/mapcore2d/dj:b	([B)[B
    //   44: astore_1
    //   45: goto -33 -> 12
    ...
    //   101: ldc 23
    //   103: ldc 234
    //   105: invokestatic 30	com/amap/api/mapcore2d/dn:a	(Ljava/lang/Throwable;Ljava/lang/String;Ljava/lang/String;)V
    //   108: aload_1
    //   109: invokevirtual 235	com/amap/api/mapcore2d/da:printStackTrace	()V
    //   112: iconst_0
    //   113: ireturn
    //   114: astore_1
    //   115: aload_1
    //   116: ldc 23
    //   118: ldc 234
    //   120: invokestatic 30	com/amap/api/mapcore2d/dn:a	(Ljava/lang/Throwable;Ljava/lang/String;Ljava/lang/String;)V
    //   123: aload_1
    ...
    //   21	30	99	com/amap/api/mapcore2d/da
    //   48	59	99	com/amap/api/mapcore2d/da
    //   59	84	99	com/amap/api/mapcore2d/da
    //   87	96	99	com/amap/api/mapcore2d/da
    //   115	127	99	com/amap/api/mapcore2d/da
  ...
  private String c(Context paramContext)
  {
    try
    {
      String str = dl.a(paramContext);
      if ("".equals(str))
        return null;
      paramContext = dd.b(paramContext, str.getBytes("UTF-8"));
      return paramContext;
    }
    catch (UnsupportedEncodingException paramContext)
    {
      dn.a(paramContext, "LogProcessor", "getPublicInfo");
      paramContext.printStackTrace();
      return null;
    }
    catch (Throwable paramContext)
  ...
  private String c(String paramString)
  {
    ...
    //   1: astore 7
    //   3: aload_0
    //   4: getfield 21	com/amap/api/mapcore2d/dw:a	Lcom/amap/api/mapcore2d/er;
    //   7: ifnonnull +5 -> 12
    //   10: aconst_null
    //   11: areturn
    //   12: aload_0
    //   13: getfield 21	com/amap/api/mapcore2d/dw:a	Lcom/amap/api/mapcore2d/er;
    //   16: aload_1
    //   17: invokevirtual 251	com/amap/api/mapcore2d/er:a	(Ljava/lang/String;)Lcom/amap/api/mapcore2d/er$b;
    //   20: astore_1
    //   21: aload 7
    //   23: astore_3
    //   24: aload_1
    ...
    //   28: aload_1
    //   29: iconst_0
    //   30: invokevirtual 256	com/amap/api/mapcore2d/er$b:a	(I)Ljava/io/InputStream;
    //   33: astore_1
    ...
    //   102: ldc 23
    //   104: ldc_w 271
    //   107: invokestatic 30	com/amap/api/mapcore2d/dn:a	(Ljava/lang/Throwable;Ljava/lang/String;Ljava/lang/String;)V
    //   110: aload 5
    //   112: astore 4
    //   114: aload_1
    //   115: astore_3
    ...
    //   146: ldc 23
    //   148: ldc_w 277
    //   151: invokestatic 30	com/amap/api/mapcore2d/dn:a	(Ljava/lang/Throwable;Ljava/lang/String;Ljava/lang/String;)V
    //   154: aload_1
    ...
    //   201: ldc 23
    //   203: ldc_w 277
    //   206: invokestatic 30	com/amap/api/mapcore2d/dn:a	(Ljava/lang/Throwable;Ljava/lang/String;Ljava/lang/String;)V
    //   209: aload_1
    ...
    //   218: ldc 23
    //   220: ldc_w 283
    //   223: invokestatic 30	com/amap/api/mapcore2d/dn:a	(Ljava/lang/Throwable;Ljava/lang/String;Ljava/lang/String;)V
    //   226: aload_3
    ...
    //   235: ldc 23
    //   237: ldc_w 283
    //   240: invokestatic 30	com/amap/api/mapcore2d/dn:a	(Ljava/lang/Throwable;Ljava/lang/String;Ljava/lang/String;)V
    //   243: aload_3
    ...
    //   265: ldc 23
    //   267: ldc_w 271
    //   270: invokestatic 30	com/amap/api/mapcore2d/dn:a	(Ljava/lang/Throwable;Ljava/lang/String;Ljava/lang/String;)V
    //   273: aload 5
    //   275: astore 4
    //   277: aload_1
    //   278: astore_3
    ...
    //   309: ldc 23
    //   311: ldc_w 277
    //   314: invokestatic 30	com/amap/api/mapcore2d/dn:a	(Ljava/lang/Throwable;Ljava/lang/String;Ljava/lang/String;)V
    //   317: aload_1
    ...
    //   325: ldc 23
    //   327: ldc_w 283
    //   330: invokestatic 30	com/amap/api/mapcore2d/dn:a	(Ljava/lang/Throwable;Ljava/lang/String;Ljava/lang/String;)V
    //   333: aload_3
    ...
    //   370: ldc 23
    //   372: ldc_w 283
    //   375: invokestatic 30	com/amap/api/mapcore2d/dn:a	(Ljava/lang/Throwable;Ljava/lang/String;Ljava/lang/String;)V
    //   378: aload_3
    ...
    //   387: ldc 23
    //   389: ldc_w 277
    //   392: invokestatic 30	com/amap/api/mapcore2d/dn:a	(Ljava/lang/Throwable;Ljava/lang/String;Ljava/lang/String;)V
    //   395: aload_1
  ...
  void b(Context paramContext)
  {
    ...
    try
    {
      ...
      {
        localei = new ei(paramContext);
        a(localei, b());
        localList = localei.a(0, b());
    ...
    {
      dn.a(paramContext, "LogProcessor", "processUpdateLog");
      paramContext.printStackTrace();
      return;
    }
  ...
  void c()
  {
    ...
    {
      dn.a(localIOException, "LogProcessor", "closeDiskLru");
      localIOException.printStackTrace();
      return;
    }
    catch (Throwable localThrowable)
    {
      dn.a(localThrowable, "LogProcessor", "closeDiskLru");
