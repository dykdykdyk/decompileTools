  ...
  implements Closeable
{
  ...
  public ev(InputStream paramInputStream, int paramInt, Charset paramCharset)
  {
    if ((paramInputStream == null) || (paramCharset == null))
      throw new NullPointerException();
    if (paramInt < 0)
      throw new IllegalArgumentException("capacity <= 0");
    if (!paramCharset.equals(ew.a))
  ...
  public ev(InputStream paramInputStream, Charset paramCharset)
  {
    ...
    throws IOException
  {
    ...
    while (true)
    {
      ...
      label267: for (int j = i - 1; ; j = i)
      {
        ...
        this.d = (i + 1);
        return localObject2;
        localObject2 = new ev.1(this, this.e - this.d + 80);
        while (true)
        {
