...
abstract class dy
{
  ...
  private String a(Context paramContext, di paramdi)
  {
    return dd.a(paramContext, paramdi);
  }
  ...
  private String a(Context paramContext, String paramString)
  {
    try
    {
      paramContext = dl.a(paramContext, paramString.getBytes("UTF-8"));
      return paramContext;
    }
  ...
  private void a(ei paramei, String paramString1, String paramString2, int paramInt, boolean paramBoolean)
  {
    ek localek = new ek();
    localek.a(0);
    localek.b(paramString1);
    localek.a(paramString2);
    paramei.b(localek, paramInt);
  }

  // ERROR //
  private boolean a(Context paramContext, String paramString1, String paramString2, String paramString3, ei paramei)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore 15
    ...
    //   110: astore 8
    //   112: aload 19
    //   114: getstatic 118	com/amap/api/mapcore2d/dv:a	Ljava/lang/String;
    ...
    //   307: iconst_1
    //   308: ldc2_w 132
    //   311: invokestatic 138	com/amap/api/mapcore2d/er:a	(Ljava/io/File;IIJ)Lcom/amap/api/mapcore2d/er;
    //   314: astore_1
    //   315: aload_1
    //   316: astore 9
    //   318: aload 13
    ...
    //   337: aload_0
    //   338: aload 5
    //   340: invokevirtual 141	com/amap/api/mapcore2d/dy:a	(Lcom/amap/api/mapcore2d/ei;)Lcom/amap/api/mapcore2d/eu;
    //   343: invokevirtual 144	com/amap/api/mapcore2d/er:a	(Lcom/amap/api/mapcore2d/eu;)V
    //   346: aload_1
    //   347: astore 9
    //   349: aload 13
    //   351: astore 12
    ...
    //   367: aload_1
    //   368: aload_2
    //   369: invokevirtual 147	com/amap/api/mapcore2d/er:a	(Ljava/lang/String;)Lcom/amap/api/mapcore2d/er$b;
    //   372: astore_3
    //   373: aload_3
    //   374: ifnull +32 -> 406
    //   377: iconst_0
    ...
    //   390: ifnull +14 -> 404
    //   393: aload_1
    //   394: invokevirtual 149	com/amap/api/mapcore2d/er:a	()Z
    //   397: ifne +7 -> 404
    //   400: aload_1
    //   401: invokevirtual 152	com/amap/api/mapcore2d/er:close	()V
    //   404: iconst_0
    //   405: ireturn
    //   406: aload_1
    //   407: astore 9
    ...
    //   456: aload_1
    //   457: aload_2
    //   458: invokevirtual 155	com/amap/api/mapcore2d/er:b	(Ljava/lang/String;)Lcom/amap/api/mapcore2d/er$a;
    //   461: astore 4
    //   463: aload_1
    //   464: astore 9
    //   466: aload 13
    ...
    //   484: aload 4
    //   486: iconst_0
    //   487: invokevirtual 160	com/amap/api/mapcore2d/er$a:a	(I)Ljava/io/OutputStream;
    //   490: astore_2
    //   491: aload_1
    //   492: astore 9
    //   494: aload_2
    ...
    //   530: astore 8
    //   532: aload 4
    //   534: invokevirtual 168	com/amap/api/mapcore2d/er$a:a	()V
    //   537: aload_1
    //   538: astore 9
    //   540: aload_2
    //   541: astore 12
    ...
    //   553: astore 8
    //   555: aload_1
    //   556: invokevirtual 170	com/amap/api/mapcore2d/er:b	()V
    //   559: aload_2
    //   560: ifnull +7 -> 567
    //   563: aload_2
    ...
    //   568: ifnull +14 -> 582
    //   571: aload_1
    //   572: invokevirtual 149	com/amap/api/mapcore2d/er:a	()Z
    //   575: ifne +7 -> 582
    //   578: aload_1
    //   579: invokevirtual 152	com/amap/api/mapcore2d/er:close	()V
    //   582: iconst_1
    //   583: ireturn
    //   584: astore_1
    //   585: aload 9
    ...
    //   609: ifnull +16 -> 625
    //   612: aload 9
    //   614: invokevirtual 149	com/amap/api/mapcore2d/er:a	()Z
    //   617: ifne +8 -> 625
    //   620: aload 9
    //   622: invokevirtual 152	com/amap/api/mapcore2d/er:close	()V
    //   625: iconst_0
    //   626: ireturn
    //   627: astore_1
    //   628: aload 10
    ...
    //   652: ifnull -27 -> 625
    //   655: aload 10
    //   657: invokevirtual 149	com/amap/api/mapcore2d/er:a	()Z
    //   660: ifne -35 -> 625
    //   663: aload 10
    //   665: invokevirtual 152	com/amap/api/mapcore2d/er:close	()V
    //   668: goto -43 -> 625
    //   671: astore_1
    //   672: aload_1
    ...
    //   692: ifnull +16 -> 708
    //   695: aload 7
    //   697: invokevirtual 149	com/amap/api/mapcore2d/er:a	()Z
    //   700: ifne +8 -> 708
    //   703: aload 7
    //   705: invokevirtual 152	com/amap/api/mapcore2d/er:close	()V
    //   708: aload_1
    //   709: athrow
    //   710: astore_2
    //   711: aload_2
  ...
  // ERROR //
  private List<di> b(Context paramContext)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore_2
    ...
    //   7: aload 4
    //   9: monitorenter
    //   10: new 183	com/amap/api/mapcore2d/el
    //   13: dup
    //   14: aload_1
    //   15: iconst_0
    //   16: invokespecial 186	com/amap/api/mapcore2d/el:<init>	(Landroid/content/Context;Z)V
    //   19: invokevirtual 189	com/amap/api/mapcore2d/el:a	()Ljava/util/List;
    //   22: astore_1
    //   23: aload 4
    //   25: monitorexit
    //   26: aload_1
  ...
  private String c()
  {
    return dz.a(new Date().getTime());
  }

  private String c(Context paramContext)
  {
    return db.a(paramContext);
  }

  protected abstract int a();

  protected abstract eu a(ei paramei);
  ...
  protected String a(Throwable paramThrowable)
  {
    try
    {
      paramThrowable = dz.a(paramThrowable);
  ...
  protected abstract String a(List<di> paramList);
  ...
  void a(Context paramContext)
  {
    ...
    synchronized (Looper.getMainLooper())
    {
      ...
      boolean bool = a(paramContext, (String)localObject1, str2, str1, localei);
      a(localei, this.a.a(), (String)localObject1, i, bool);
      return;
    }
  }
  ...
  void a(Context paramContext, Throwable paramThrowable, String paramString1, String paramString2)
  {
    ...
    while (true)
    {
      if (!((Iterator)localObject1).hasNext())
        break label22;
      di localdi = (di)((Iterator)localObject1).next();
      if (!a(localdi.f(), str1))
        break;
      a(localdi);
      ??? = c();
      String str3 = a(paramContext, localdi);
      ...
      synchronized (Looper.getMainLooper())
      {
        localObject3 = new ei(paramContext);
        boolean bool = a(paramContext, str2, str4, str3, (ei)localObject3);
        a((ei)localObject3, localdi.a(), str2, i, bool);
      }
    }
  }

  protected void a(di paramdi)
  {
    this.a = paramdi;
  }
