...
public abstract class PushMessageReceiver extends BroadcastReceiver
{
  ...
  public final void onReceive(Context paramContext, Intent paramIntent)
  {
    ...
    do
    {
      ...
      if (m.q(paramContext, (String)localObject4))
      {
        Log.e(TAG, " receive message duplicated !");
        return;
      }
      new PushMessageReceiver.2(this, paramContext, i, paramIntent, (String)localObject4, (byte[])localObject1, (byte[])localObject3, new PushMessageReceiver.1(this, paramContext)).start();
      return;
    ...
    {
      if (a.b() > 0)
        t.a(paramContext, "039905", j, (String)localObject1);
      if ((j == 0) && (!TextUtils.isEmpty((CharSequence)localObject1)))
        try
        {
          ...
          i.a(paramContext, (String)localObject5, str1, (String)localObject4, str2, true, m.d(paramContext, paramContext.getPackageName()), l, (String)localObject1, (String)localObject3);
          onBind(paramContext, j, (String)localObject5, str2, str1, (String)localObject4);
          m.a("onBind from" + paramContext.getPackageName() + " errorCode " + j + " appid " + (String)localObject5 + " userId " + str2 + " channelId " + str1 + " requestId " + (String)localObject4 + " at time of " + System.currentTimeMillis(), paramContext);
          ...
          n.a(paramContext, paramContext.getPackageName() + ".self_push_sync", "bindinfo", paramIntent);
          return;
        }
        catch (Exception paramIntent)
        {
          ...
          if (a.b() > 0)
            t.a(paramContext, "039905", -1, m.a(paramIntent));
          m.a("onBind from" + paramContext.getPackageName() + " errorCode " + j + " at time of " + System.currentTimeMillis() + " exception " + m.a(paramIntent), paramContext);
          return;
        }
      onBind(paramContext, j, null, null, null, null);
      if (a.b() > 0)
        t.a(paramContext, "039905", -1, String.valueOf(j));
      m.a("onBind from" + paramContext.getPackageName() + " errorCode " + j + " at time of " + System.currentTimeMillis(), paramContext);
      return;
    }
    if ((((String)localObject3).equals("method_unbind")) || (((String)localObject3).equals("method_lapp_unbind")))
    {
      ...
      try
      {
        ...
        paramIntent.commit();
        m.a("unbind from" + paramContext.getPackageName() + " errorCode " + j + " at time of " + System.currentTimeMillis(), paramContext);
        return;
      }
    ...
    if ((((String)localObject3).equals("method_set_tags")) || (((String)localObject3).equals("method_set_lapp_tags")))
    {
      ...
      i = 0;
      label1119: if (i < ((JSONArray)localObject2).length())
      {
