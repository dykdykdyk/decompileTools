  ...
  implements c
{
  ...
  public b(String paramString, int paramInt1, int paramInt2, c paramc)
  {
    this.a = paramString;
    this.c = paramInt1;
    this.d = paramInt2;
  ...
  public Bitmap a(String paramString)
  {
    ...
    do
    {
      ...
      ((BitmapFactory.Options)localObject).inSampleSize = a.a((BitmapFactory.Options)localObject, -1, this.d);
    ...
    if ((((Integer)localObject).intValue() + 1 >= this.c) && (this.b != null))
    {
      this.b.a(paramString, localBitmap);
      this.e.remove(paramString);
      return localBitmap;
    }
    this.e.put(paramString, Integer.valueOf(((Integer)localObject).intValue() + 1));
    return localBitmap;
  }
  ...
  public void a(String paramString, Bitmap paramBitmap)
  {
    ...
    //   4: aload_0
    //   5: aload_1
    //   6: invokevirtual 49	com/baidu/android/pushservice/a/a/b:c	(Ljava/lang/String;)Ljava/lang/String;
    ...
    //   65: aload_0
    //   66: getfield 26	com/baidu/android/pushservice/a/a/b:e	Ljava/util/Map;
    //   69: aload_1
    //   70: iconst_1
  ...
  {
    return this.a + "/" + paramString + ".png";
  }
}

/* Location:           C:\crazyd\work\ustone\odm2016031702\baidu\android\nut-dex2jar.jar
 * Qualified Name:     com.baidu.android.pushservice.a.a.b
