...
public class d
{
  ...
  public static String a()
  {
    ...
    while (true)
      ...
      {
        com.baidu.android.pushservice.h.a.e("LbsUtils", "error : " + localSocketException.toString());
        return "";
      }
  ...
  public static String a(Context paramContext)
  {
    if (paramContext == null)
      return null;
    return b.a(paramContext, "com.baidu.android.pushservice.lbscache");
  }
  ...
  public static String a(Context paramContext, JSONObject paramJSONObject)
  {
    ...
    try
    {
      ...
      b.a(paramContext, "com.baidu.android.pushservice.lbscache", localJSONObject1.toString());
      return localJSONObject1.toString();
    }
    catch (JSONException paramContext)
    {
      com.baidu.android.pushservice.h.a.e("LbsUtils", "error " + paramContext.getMessage());
    }
    return null;
  }
    ...
    if (!TextUtils.isEmpty(str1))
    {
      ...
      if (!TextUtils.isEmpty(str2))
      {
        if ((!paramBoolean) && (b(paramContext)) && (!TextUtils.isEmpty(a(paramContext))))
          return null;
        String str3 = a();
        Object localObject = com.baidu.android.pushservice.c.b.a(paramContext);
        new ArrayList();
        JSONArray localJSONArray = new JSONArray();
        JSONObject localJSONObject1 = new JSONObject();
        localObject = ((com.baidu.android.pushservice.c.b)localObject).a;
        int i = 0;
        while (true)
          if (i < ((ArrayList)localObject).size())
          {
            ...
            try
            {
              localJSONObject2.put("userid", m.b(((h)((ArrayList)localObject).get(i)).e));
            ...
            {
              while (true)
                com.baidu.android.pushservice.h.a.e("LbsUtils", "error " + localException.getMessage());
            }
          }
        if (localJSONArray.length() > 0)
          try
          {
            ...
            localJSONObject1.put("nettype", m.t(paramContext.getApplicationContext()));
  ...
  {
    i.a(paramContext, "com.baidu.pushservice.clt", paramLong);
  }
  ...
  public static boolean b(Context paramContext)
  {
    ...
    do
    {
      return false;
      str1 = e(paramContext);
      str2 = b.a(paramContext, "com.baidu.android.pushservice.lac");
    }
    ...
    b.a(paramContext, "com.baidu.android.pushservice.lac", str1);
    return false;
  }
  ...
  public static long c(Context paramContext)
  {
    if (paramContext == null)
    {
      com.baidu.android.pushservice.h.a.e("LbsUtils", "getLastSendLbsTime mContext == null");
      return 0L;
    }
    return i.b(paramContext, "com.baidu.pushservice.clt");
  }
