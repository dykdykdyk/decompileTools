...
public class a extends c
{
  ...
  private int a(String paramString)
  {
    ...
    //   65: invokestatic 71	com/baidu/android/pushservice/h/a:c	(Ljava/lang/String;Ljava/lang/String;)V
    //   68: aload_1
    //   69: ifnull +563 -> 632
    //   72: aload_1
    //   73: astore 10
    ...
    //   129: invokestatic 102	com/baidu/android/pushservice/util/m:a	(Ljava/lang/String;Landroid/content/Context;)V
    //   132: aload_1
    //   133: astore 10
    ...
    //   154: invokestatic 71	com/baidu/android/pushservice/h/a:c	(Ljava/lang/String;Ljava/lang/String;)V
    //   157: iload_2
    //   158: iconst_1
    ...
    //   260: aload_1
    //   261: astore 10
    //   263: invokestatic 120	com/baidu/android/pushservice/util/m:c	()J
    //   266: lstore 8
    //   268: aload_1
    //   269: astore 10
    ...
    //   321: invokestatic 102	com/baidu/android/pushservice/util/m:a	(Ljava/lang/String;Landroid/content/Context;)V
    //   324: aload_1
    //   325: astore 10
    ...
    //   376: invokestatic 71	com/baidu/android/pushservice/h/a:c	(Ljava/lang/String;Ljava/lang/String;)V
    //   379: iload 5
    //   381: iconst_1
    //   382: iadd
    //   383: iload_3
    ...
    //   440: invokestatic 102	com/baidu/android/pushservice/util/m:a	(Ljava/lang/String;Landroid/content/Context;)V
    //   443: iload_3
    //   444: ireturn
    //   445: astore_1
    ...
    //   468: invokestatic 143	com/baidu/android/pushservice/h/a:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   471: iload_2
    //   472: istore_3
    //   473: goto -53 -> 420
    //   476: astore 11
    ...
    //   508: invokestatic 143	com/baidu/android/pushservice/h/a:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   511: iload_2
    //   512: istore_3
    //   513: aload_1
    //   514: ifnull -94 -> 420
    ...
    //   551: invokestatic 143	com/baidu/android/pushservice/h/a:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   554: iload_2
    //   555: istore_3
    //   556: goto -136 -> 420
    //   559: astore_1
    ...
    //   602: invokestatic 143	com/baidu/android/pushservice/h/a:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   605: goto -30 -> 575
    //   608: astore_1
    //   609: goto -46 -> 563
    //   612: astore 11
  ...
  {
    paramArrayOfByte1 = j.a(this.a, paramString2, paramString1, paramArrayOfByte2);
    if (paramArrayOfByte1 != null)
    {
      if (com.baidu.android.pushservice.a.b() > 0)
        paramArrayOfByte1.handleADShowNotification(this.a, paramString2, paramString1, "01", String.valueOf(paramArrayOfByte1.mAdvertiseStyle));
      paramArrayOfByte2 = d.a(this.a, paramString1);
      switch (a.1.a[paramArrayOfByte2.a().ordinal()])
      {
      default:
        com.baidu.android.pushservice.h.a.c(b, ">>> no push client receive advertise message");
        paramArrayOfByte1.handleADShowNotification(this.a, paramString2, paramString1, "06", String.valueOf(paramArrayOfByte1.mAdvertiseStyle));
        com.baidu.android.pushservice.h.a.c(b, ">>> Not Show pMsg AD Notification!  errorcode = 65536");
        m.a(">>>Not Show pMsg AD Notification! errorcode = 65536", this.a);
        paramInt = 65536;
      case 1:
      }
    }
    while (true)
    {
      m.a("AdvertiseHandler handleMessage returnResult = " + paramInt, this.a);
      return paramInt;
      paramArrayOfByte1.mPkgName = paramArrayOfByte2.a.c();
      paramInt = a(paramArrayOfByte1.mPkgName);
      if ((paramInt == 2) || (paramInt == 3))
      {
        if (paramInt == 2)
          paramArrayOfByte1.handleADShowNotification(this.a, paramString2, paramString1, "02", String.valueOf(paramArrayOfByte1.mAdvertiseStyle));
        while (true)
        {
          paramInt = ((byte)(paramInt & 0xFF) & 0xFF) << 16 & 0xFF0000;
          com.baidu.android.pushservice.h.a.c(b, ">>> Not Show pMsg AD Notification!  errorcode = " + paramInt);
          m.a(">>>Not Show pMsg AD Notification! errorcode = " + paramInt, this.a);
          com.baidu.android.pushservice.h.a.c(b, "returnresult(pushclient)  =  " + paramInt);
          break;
          if (paramInt == 3)
            paramArrayOfByte1.handleADShowNotification(this.a, paramString2, paramString1, "03", String.valueOf(paramArrayOfByte1.mAdvertiseStyle));
        }
      }
      paramArrayOfByte2 = f.a(this.a, paramArrayOfByte1, paramString2, paramString1);
      if (paramArrayOfByte2 == null)
        paramArrayOfByte1.handleADShowNotification(this.a, paramString2, paramString1, "04", String.valueOf(paramArrayOfByte1.mAdvertiseStyle));
      for (paramInt = 65536; ; paramInt = 1)
      {
        m.a("showAdvertiseNotification returnResult = " + paramInt, this.a);
        com.baidu.android.pushservice.h.a.c(b, ">>> Show pMsg AD Notification!");
        break;
        com.baidu.android.pushservice.h.a.c(b, "componentName = " + paramArrayOfByte2);
        if (com.baidu.android.pushservice.a.b() > 0)
          paramArrayOfByte1.handleADShowNotification(this.a, paramString2, paramString1, "05", String.valueOf(paramArrayOfByte1.mAdvertiseStyle));
      }
      paramInt = 0;
    }
  }
