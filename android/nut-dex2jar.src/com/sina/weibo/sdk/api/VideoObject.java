...
public class VideoObject extends BaseMediaObject
{
  ...
  public final boolean a()
  {
    ...
    {
      i.c("Weibo.VideoObject", "checkArgs fail, dataUrl is invalid");
      return false;
    }
    if ((this.j != null) && (this.j.length() > 512))
    {
      i.c("Weibo.VideoObject", "checkArgs fail, dataHdUrl is invalid");
      return false;
    }
    if (this.k <= 0)
    {
      i.c("Weibo.VideoObject", "checkArgs fail, duration is invalid");
      return false;
    }
    return true;
  }
