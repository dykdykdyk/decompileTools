...
public class VoiceObject extends BaseMediaObject
{
  ...
  public final boolean a()
  {
    ...
    {
      i.c("Weibo.VoiceObject", "checkArgs fail, dataUrl is invalid");
      return false;
    }
    if ((this.j != null) && (this.j.length() > 512))
    {
      i.c("Weibo.VoiceObject", "checkArgs fail, dataHdUrl is invalid");
      return false;
    }
    if (this.k <= 0)
    {
      i.c("Weibo.VoiceObject", "checkArgs fail, duration is invalid");
      return false;
    }
    return true;
  }
