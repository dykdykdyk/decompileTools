    ...
    try
    {
      ...
      if (checkOffset(paramString, i, '-'))
      {
        ...
        if (checkOffset(paramString, j, '-'))
        {
          ...
          {
            GregorianCalendar localGregorianCalendar = new GregorianCalendar(i2, i3 - 1, i4);
