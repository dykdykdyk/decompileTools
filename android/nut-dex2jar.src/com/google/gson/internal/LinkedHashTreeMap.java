  ...
  implements Serializable
{
  ...
  static <K, V> LinkedHashTreeMap.Node<K, V>[] doubleCapacity(LinkedHashTreeMap.Node<K, V>[] paramArrayOfNode)
  {
    ...
    if (i < m)
    {
      ...
      if (localObject != null)
      {
        ...
        label179: arrayOfNode[i] = localObject;
        if (k <= 0)
          break label218;
      }
      label212: label218: for (localObject = localAvlBuilder2.root(); ; localObject = null)
      {
  ...
  final LinkedHashTreeMap.Node<K, V> find(K paramK, boolean paramBoolean)
  {
    ...
    if (localObject1 != null)
    {
      ...
      label95: for (i = localComparable.compareTo(((LinkedHashTreeMap.Node)localObject1).key); ; i = localComparator.compare(paramK, ((LinkedHashTreeMap.Node)localObject1).key))
      {
        if (i != 0)
          break label112;
    ...
    while (true)
    {
      label145: localObject2 = localObject3;
      if (!paramBoolean)
        break;
