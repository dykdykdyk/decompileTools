...
public final class h
{
  ...
  private h(char paramChar, float[] paramArrayOfFloat)
  {
    this.a = paramChar;
  ...
  {
    this.a = paramh.a;
    this.b = f.a(paramh.b, paramh.b.length);
  }
  ...
  static void a(Path paramPath, float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4, float paramFloat5, float paramFloat6, float paramFloat7, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    label415: label421: for (double d1 = d4 - 6.283185307179586D; ; d1 = d4 + 6.283185307179586D)
    {
      d3 *= paramFloat5;
      d2 = paramFloat6 * d2;
