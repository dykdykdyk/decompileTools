  ...
  implements ComponentCallbacks, View.OnCreateContextMenuListener
{
  ...
  ad mChildFragmentManager;
  ViewGroup mContainer;
  int mContainerId;
  boolean mDeferStart;
  boolean mDetached;
  Object mEnterTransition = null;
  cw mEnterTransitionCallback = null;
  Object mExitTransition = null;
  cw mExitTransitionCallback = null;
  int mFragmentId;
  ad mFragmentManager;
  boolean mFromLayout;
  boolean mHasMenu;
  ...
  public final ac getChildFragmentManager()
  {
    if (this.mChildFragmentManager == null)
    {
  ...
  public final ac getFragmentManager()
  {
  ...
  public LayoutInflater getLayoutInflater(Bundle paramBundle)
  {
    ...
    z.a(paramBundle, this.mChildFragmentManager);
    return paramBundle;
  }

  public av getLoaderManager()
  {
    if (this.mLoaderManager != null)
  ...
  public final Resources getResources()
  {
    if (this.mHost == null)
      throw new IllegalStateException("Fragment " + this + " not attached to Activity");
    return this.mHost.c.getResources();
  }
  ...
  {
    this.mChildFragmentManager = new ad();
    this.mChildFragmentManager.a(this.mHost, new t(this), this);
  }
  ...
  void performActivityCreated(Bundle paramBundle)
  {
    ...
    if (!this.mCalled)
      throw new cx("Fragment " + this + " did not call through to super.onActivityCreated()");
    if (this.mChildFragmentManager != null)
      this.mChildFragmentManager.h();
  }
  ...
  void performCreate(Bundle paramBundle)
  {
    ...
    if (!this.mCalled)
      throw new cx("Fragment " + this + " did not call through to super.onCreate()");
    if (paramBundle != null)
    {
  ...
  void performDestroy()
  {
    ...
    onDestroy();
    if (!this.mCalled)
      throw new cx("Fragment " + this + " did not call through to super.onDestroy()");
  }
  ...
  void performDestroyView()
  {
    ...
    onDestroyView();
    if (!this.mCalled)
      throw new cx("Fragment " + this + " did not call through to super.onDestroyView()");
    if (this.mLoaderManager != null)
  ...
  {
    if (this.mChildFragmentManager != null)
      this.mChildFragmentManager.b(4);
    this.mState = 4;
    this.mCalled = false;
    onPause();
    if (!this.mCalled)
      throw new cx("Fragment " + this + " did not call through to super.onPause()");
  }
  ...
  {
    if (this.mChildFragmentManager != null)
      this.mChildFragmentManager.b(2);
    this.mState = 2;
    if (this.mLoadersStarted)
    {
      this.mLoadersStarted = false;
  ...
  void performResume()
  {
    ...
    onResume();
    if (!this.mCalled)
      throw new cx("Fragment " + this + " did not call through to super.onResume()");
    if (this.mChildFragmentManager != null)
    {
      this.mChildFragmentManager.j();
      this.mChildFragmentManager.d();
  ...
  void performSaveInstanceState(Bundle paramBundle)
  {
    ...
    if (this.mChildFragmentManager != null)
    {
      Parcelable localParcelable = this.mChildFragmentManager.f();
  ...
  void performStart()
  {
    ...
    onStart();
    if (!this.mCalled)
      throw new cx("Fragment " + this + " did not call through to super.onStart()");
    if (this.mChildFragmentManager != null)
      this.mChildFragmentManager.i();
    if (this.mLoaderManager != null)
  ...
  void performStop()
  {
    ...
    onStop();
    if (!this.mCalled)
      throw new cx("Fragment " + this + " did not call through to super.onStop()");
  }
  ...
  final void restoreViewState(Bundle paramBundle)
  {
    ...
    if (!this.mCalled)
      throw new cx("Fragment " + this + " did not call through to super.onViewStateRestored()");
  }
  ...
  public void setEnterSharedElementCallback(cw paramcw)
  {
    this.mEnterTransitionCallback = paramcw;
  }
  ...
  public void setExitSharedElementCallback(cw paramcw)
  {
    this.mExitTransitionCallback = paramcw;
  }
