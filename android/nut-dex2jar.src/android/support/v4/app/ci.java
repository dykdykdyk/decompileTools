  ...
  implements be, bf
{
  ...
  {
    this.c.add(ch.a(this.a, paramcd));
  }

  public final Notification b()
  {
    Notification localNotification = this.a.build();
    Object localObject = ch.a(localNotification);
    ...
    localObject = ch.a(this.c);
    if (localObject != null)
      ch.a(localNotification).putSparseParcelableArray("android.support.actionExtras", (SparseArray)localObject);
