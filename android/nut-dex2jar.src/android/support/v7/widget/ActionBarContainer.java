...
public class ActionBarContainer extends FrameLayout
{
  ...
  public ActionBarContainer(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    while (true)
    {
      ...
      label138: bool = false;
      continue;
      label143: if ((this.a == null) && (this.b == null))
        bool = true;
      else
        bool = false;
    }
  ...
  public void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    label167: for (paramInt2 = View.MeasureSpec.getSize(k); ; paramInt2 = 2147483647)
    {
  ...
  public void setTabContainer(ex paramex)
  {
    if (this.g != null)
      removeView(this.g);
    this.g = paramex;
    ...
    {
      addView(paramex);
      ViewGroup.LayoutParams localLayoutParams = paramex.getLayoutParams();
      localLayoutParams.width = -1;
      localLayoutParams.height = -2;
      paramex.setAllowCollapse(false);
    }
  }
